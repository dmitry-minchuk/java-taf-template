...
public class TestPlaywrightAddPropertyLegacy extends BaseTest {

    @Test
    @TestCaseId("EPBDS-6964-LEGACY")
    @Description("Playwright - Exception occurs on adding property to the table with two columns - migrated from legacy")
    @AppContainerConfig(startParams = AppContainerStartParameters.DEFAULT_STUDIO_PARAMS)
    public void testPlaywrightAddPropertyLegacy() {
