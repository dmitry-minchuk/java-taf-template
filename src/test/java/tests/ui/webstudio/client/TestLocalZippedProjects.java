...
public class TestLocalZippedProjects extends BaseTest {
    ...
    private static final String ROOT_DIR_PATH = "/Users/dmitryminchuk/Projects/eis/client_projects/сustomers_projects_test_automation_6.x";
        ...
        for (String nameProject : projectNames) {
            ...
            if (!modules.isEmpty()) {
                ...
                if (editorPage.getEditorToolbarPanelComponent().getTestDropdownBtn().isVisible()) {
                    ...
                    String contextMsg = String.format("project=%s%nlocations:%n%s",
                            nameProject, StringUtil.prettyPrintObjectList.apply(projectPaths));
                    try {
