...
public class RepositoriesPageComponent extends BaseComponent {
    ...
    private void initializeElements() {
        ...
        designRepositoryList = createScopedElementList("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-nav-list')]/div[@data-node-key]", "designRepositoryList");
        ...
        remoteRepositoryNameField = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='name']", "remoteRepositoryNameField");
        // Type selector: scope to the ant-select that contains input[@id='type'] to avoid matching other selects (e.g. Deployment branch)
        remoteRepositoryTypeSelector = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//div[contains(@class,'ant-select') and .//input[@id='type']]//div[contains(@class,'ant-select-content')]", "remoteRepositoryTypeSelector");
        remoteRepositoryCheckBox = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_remoteRepository']", "remoteRepositoryCheckBox");
        remoteRepositoryPathField = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_uri']", "remoteRepositoryPathField");
        remoteRepositoryLoginField = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_login']", "remoteRepositoryLoginField");
        remoteRepositoryPasswordField = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_password']", "remoteRepositoryPasswordField");
        remoteRepositoryBranchField = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_branch']", "remoteRepositoryBranchField");
        remoteRepositoryProtectedBranchesField = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_protectedBranches']", "remoteRepositoryProtectedBranchesField");
        flatFolderStructureCheckBox = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_flatFolderStructure']", "flatFolderStructureCheckBox");
        secureConnectionCheckbox = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tabpane-active')]//input[@id='settings_secure']", "secureConnectionCheckbox");
        applyChangesBtn = createScopedElement("xpath=.//button[@type='submit']", "applyChangesBtn");
        designRepoActiveTab = createScopedElement("xpath=.//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-tab-active') and .//*[text()='%s']]", "designRepoActiveTab");
        ...
        repositoryTabTemplate = new WebElement(page, "xpath=//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-nav-list')]//div[contains(@class,'ant-tabs-tab') and .//*[text()='%s']]", "repositoryTab");
        deleteRepositoryBtnTemplate = new WebElement(page, "xpath=//div[contains(@class,'ant-tabs-editable-card')]//div[contains(@class,'ant-tabs-nav-list')]//div[contains(@class,'ant-tabs-tab') and .//*[text()='%s']]//button[contains(@class,'ant-tabs-tab-remove')]", "deleteRepositoryBtn");
