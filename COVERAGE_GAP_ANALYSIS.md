...
| Migrated to new framework | 105 test classes (104 `Test*.java` + `CreateDataTypeTableTest`) |
...
| **New framework overall coverage** | **~59% of legacy** (up from ~57%; +2 JDBC integration tests with Testcontainers) |
